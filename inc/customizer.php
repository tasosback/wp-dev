 ...
 */
function wp_starter_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'wp-starter' ),
				'description' => __( 'Height: &gt;80px', 'wp-starter' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar Scheme', 'wp-starter' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'navbar-light bg-light'  => __( 'Default', 'wp-starter' ),
				'navbar-dark bg-dark'    => __( 'Dark', 'wp-starter' ),
				'navbar-dark bg-primary' => __( 'Primary', 'wp-starter' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'wp-starter' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'static'       => __( 'Static', 'wp-starter' ),
				'fixed_top'    => __( 'Fixed to top', 'wp-starter' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'wp-starter' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'wp-starter' ),
			'section'  => 'theme_header_section',
...
add_action( 'customize_register', 'wp_starter_customize' );
